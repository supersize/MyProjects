	...
	<div class="container">
		<div class="row">
				...
				<tbody>
					...
					<tr>
						<td >작성자</td>
						<td colspan="2">${content_view.id}</td>
					</tr>
					<tr>
						<td >작성일자</td>
...
<%-- 						<td colspan="2" style="min-height: 200px; text-align : left;"><%bdao.content_view.bContent%></td> --%>
					</tr>
					</tbody>
				</table>
				...
				%> 
						<a href="reply_write.do?bId=${content_view.bId}" class = "btn btn-primary pull-right">답글달기</a>
						<a href="update_view.do?bId=${content_view.bId}" class = "btn btn-primary pull-right">수정하기</a>
						<a href="delete.do?bId=${content_view.bId}" class = "btn btn-primary pull-right">삭제하기</a>
				<%
 					}else if(id != null){
				%>
						<a href="reply_write.do?bId=${content_view.bId}" class = "btn btn-primary pull-right">답글달기</a>
